  ...
  "Domingo",
    ...
    <div>
      ...
      <main className={mainClass}>
        ...
        <form onSubmit={handleSubmit(editar)} className="grid grid-cols-3 gap-0 md:gap-10">
          <div className="col-span-3 md:col-span-2">
            <section className="flex flex-col">
            <Accordion type="single" collapsible>
            <AccordionItem value="item-1">
                <AccordionTrigger className="cursor-pointer !no-underline border-b rounded-none h-[60px]  border-[#D9D9D9] "><h2 className={tituloClass}>Informações do Restaurante</h2></AccordionTrigger>
                <AccordionContent className=" flex flex-col mt-9 w-full gap-4">
                    ...
                    <div className="flex flex-col">
                      ...
                      <textarea onInput={(e) => {const el = e.target as HTMLTextAreaElement; el.style.height = 'auto'; el.style.height = el.scrollHeight + 'px';}}
            ...
            <AccordionItem value="item-2">
                <AccordionTrigger className="cursor-pointer !no-underline border-b rounded-none h-[60px]  border-[#D9D9D9] "><h2 className={tituloClass}>Localização</h2></AccordionTrigger>
          ...
          <section className="flex flex-col col-span-3 md:col-span-1 mb-10">
            ...
            <AccordionItem value="item-3">
                <AccordionTrigger className="cursor-pointer !no-underline border-b rounded-none h-[60px]  border-[#D9D9D9] "><h2 className={tituloClass}>Horários de Funcionamento</h2></AccordionTrigger>
                <AccordionContent className="mt-9">
