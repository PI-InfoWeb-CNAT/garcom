    ...
    <>
      ...
      <main className="flex min-h-screen flex-col items-center justify-start bg-gray-100 pt-29 pb-8">
        ...
        <section className={mainClass + " grid grid-cols-2"}>
          ...
          <div>
            <div>
              <h2 className="font-poppins mb-3 text-2xl font-semibold text-[#F65C5C]">
            ...
            <div className="grid grid-cols-2 gap-6">
              <div>
                ...
                />
                <h3 className="font-poppins mb-2 font-semibold text-[#F65C5C]">
                  Qualidade supimpa
                </h3>
              ...
              <div>
                ...
                />
                <h3 className="mb-2 font-semibold text-[#F65C5C]">Uma experiência digna</h3>
                <p className="text-[#9E9E9E]">
